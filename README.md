...
当前 CoC 路径以 Python runtime + JSON CLI + [CoC Skills](https://github.com/SagaSmithAI/SagaSmith-coc-skills) 为主，正在向 D&D 已采用的独立 MCP 与服务端工具暴露边界演进。因此它是可测试的系统实现，但尚不宣称与 D&D MCP 拥有完全相同的 Agent 集成面。
